...
%------------------------------------------------------------------------------------------------
%
%                               created by Qingyun Fang and Jason-X-Zhang
%
...
\usepackage[super,square,sort & compress,comma]{natbib}   % 参考文献设置
...
%\setCJKfamilyfont{SCB}{STSongti-SC-Regular} 			% 若使用本行设置导致编译时无法找到字体，则将本行注释，使用下一行设置
\setCJKfamilyfont{SCB}[AutoFakeBold = {2.2}]{华文宋体}      
...
\setlist[enumerate]{itemsep=0pt,parsep=0pt,topsep=0pt,leftmargin=0em,itemindent=4em,label=(\arabic*)}

%------------------------------------------------------------------------------------------------
%		公式设置
%------------------------------------------------------------------------------------------------

\newcommand{\equationskip}{\setlength\abovedisplayskip{1ex} 
	\setlength\belowdisplayskip{1ex}
	\setlength\abovedisplayshortskip{0.5ex} 
	\setlength\belowdisplayshortskip{0.5ex}}
\newcommand{\equationskipfrac}{\setlength\abovedisplayskip{1.5ex} 
